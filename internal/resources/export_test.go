...
var VaultStatsHandler = func(deps Deps) server.ResourceHandlerFunc { return cachedResourceHandler(deps, computeVaultStats) }
var VaultTagsHandler = func(deps Deps) server.ResourceHandlerFunc { return cachedResourceHandler(deps, computeVaultTags) }
